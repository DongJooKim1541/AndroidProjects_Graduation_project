...
- [개요](#개요)
- [주요 기능](#주요-기능)
- [구현되지 않은 기능](#구현되지-않은-기능)
- [잠금화면 사용 시 알아 둘 점](#잠금화면-사용-시-알아-둘-점)
- [기술 스택](#기술-스택)
- [빌드](#빌드)
- [프로젝트 구조](#프로젝트-구조)
- [문서](#문서)
...
| 오답 노트 | 틀린 문제를 연도·회차·번호로 분류해 기록하고, 문제 이미지와 정답을 다시 확인 |
| 사용자 관리 | Firebase Authentication 기반 회원가입·로그인 |
| 프로필 | 프로필 이미지 업로드 (Firebase Storage) |

## 구현되지 않은 기능

화면에는 있지만 동작하지 않거나, 의도한 범위까지 만들어지지 않은 부분입니다.
졸업 프로젝트 제출 시점에 남은 상태 그대로이며, 감추지 않고 적어 둡니다.
